      ...
      <div className='w-[500px] border-black'>
        {
          user?.uid ?
            <form onSubmit={handleSubmit(handleCreatePost)}>
              ...
              {
                addPostLoading === true ?
                  <button className='inline-block btn-disabled px-3 py-1 mt-5  bg-blue-500 hover:bg-blue-600  text-white rounded-full uppercase font-semibold'>
                    <div role="status">
                  ...
                  :
                  <button className='w-20 px-3 py-1 mt-5 bg-blue-500 hover:bg-blue-600  text-white rounded-full font-semibold'>Post</button>
              }
